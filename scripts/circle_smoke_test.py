...
api_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'services', 'api', 'src')
...
def main():
    ...
    if not api_key:
        ...
        logger.info("Mocked: Wallet is created.")
        logger.info("Mocked: USDC transfer is successful.")
        sys.exit(0)
    ...
    destination = os.getenv("CIRCLE_DESTINATION_ADDRESS", "0x0000000000000000000000000000000000000000")
